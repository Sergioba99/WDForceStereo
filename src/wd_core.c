// WDForceStereo v1.0 core - Watch Dogs (2014), configurable XAudio2 2.7 stereo
// downmix x64, no CRT.
//
// Loader-specific proxy code lives in separate translation units. This file
// contains only the shared WDForceStereo/XAudio2 implementation.
...
void WDCoreProcessAttach(HINSTANCE h) {
  HANDLE t;
  g_self = (HMODULE)h;
